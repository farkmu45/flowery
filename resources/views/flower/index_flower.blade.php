                          ...
                          <table class='table'>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <img src="{{ asset('picflower/'.$flower->picture)}}" alt="" style="width: 100px">
                                </td>
                                ...
                                <td>
                                  <div class="d-flex">
                                      ...
                                      &nbsp
                                      <form onsubmit="return confirm('Are you sure to delete it?')" action="{{ route('flower.destroy', $flower)}}" method="post">
                                        @csrf
                                        @method('DELETE')
